...
public class CategoryGridAdapter extends RecyclerView.Adapter<CategoryGridAdapter.ViewHolder> {
    ...
    public void onBindViewHolder(@NonNull ViewHolder holder, int position) {
        ...
        holder.tvPrice.setText("Starts from ₹" + (int) category.getStartingPrice());
    ...
    static class ViewHolder extends RecyclerView.ViewHolder {
        ...
        public ViewHolder(@NonNull View itemView) {
            super(itemView);
            tvName = itemView.findViewById(R.id.tvGridCategoryName);
            tvDesc = itemView.findViewById(R.id.tvGridCategoryDesc);
            tvPrice = itemView.findViewById(R.id.tvGridCategoryPrice);
            ivIcon = itemView.findViewById(R.id.ivGridCategoryIcon);
        }
    }
}
